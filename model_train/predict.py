...
def load_model(filepath="model/fuel_model.pkl"):
...
def estimate_monthly_cost(
    ...
    """
    Estimate monthly fuel cost based on:
...
if __name__ == "__main__":
    ...
    print("=== Fuel Efficiency Prediction ===")
    print(f"MPG:              {result['prediction']['mpg']}")
    print(f"KM/L:             {result['prediction']['kmpl']}")
    print(f"L/100km:          {result['prediction']['liters_per_100km']}")
    print(f"Rating:           {result['rating']['emoji']} {result['rating']['rating']}")
    print(f"Monthly Cost:     PKR {result['monthly_cost_estimate']['monthly_cost_pkr']}")
    print(f"\nTop Tips:")
