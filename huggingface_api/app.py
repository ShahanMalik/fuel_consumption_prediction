...
# Flask REST API — Hugging Face Spaces Deployment
# =============================================================
...
def home():
    return jsonify({
        "app":     "Fix My Ride — Fuel Efficiency Estimator",
        "status":  "running",
        "endpoints": {
            "GET  /":                     "This page",
            "GET  /health":               "Health check",
            "POST /predict/fuel":         "Predict fuel efficiency for a car",
            "POST /predict/fuel/compare": "Compare two cars side by side"
        },
        "example_request": {
            "url":  "POST /predict/fuel",
            "body": {
                "cylinders":    4,
                "displacement": 1300,
                "horsepower":   88,
...
def predict_fuel():
    ...
    try:
        ...
        return jsonify({
            "error": "Model not found. Ensure fuel_model.pkl is in the repository."
        }), 500
